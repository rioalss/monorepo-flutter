...
@SafeNullableIntConverter() int? get statusCode;@SafeNullableStringConverter() String? get message; Map<String, List<String>>? get errors;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApiErrorModel&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.errors, errors));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,statusCode,message,const DeepCollectionEquality().hash(errors));
...
@useResult
$Res call({
@SafeNullableIntConverter() int? statusCode,@SafeNullableStringConverter() String? message, Map<String, List<String>>? errors
});
...
/// Create a copy of ApiErrorModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? statusCode = freezed,Object? message = freezed,Object? errors = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@SafeNullableIntConverter()  int? statusCode, @SafeNullableStringConverter()  String? message,  Map<String, List<String>>? errors)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiErrorModel() when $default != null:
return $default(_that.statusCode,_that.message,_that.errors);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@SafeNullableIntConverter()  int? statusCode, @SafeNullableStringConverter()  String? message,  Map<String, List<String>>? errors)  $default,) {final _that = this;
switch (_that) {
case _ApiErrorModel():
return $default(_that.statusCode,_that.message,_that.errors);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@SafeNullableIntConverter()  int? statusCode, @SafeNullableStringConverter()  String? message,  Map<String, List<String>>? errors)?  $default,) {final _that = this;
switch (_that) {
case _ApiErrorModel() when $default != null:
return $default(_that.statusCode,_that.message,_that.errors);case _:
  return null;
...
class _ApiErrorModel implements ApiErrorModel {
  const _ApiErrorModel({@SafeNullableIntConverter() this.statusCode, @SafeNullableStringConverter() this.message, final  Map<String, List<String>>? errors}): _errors = errors;
  factory _ApiErrorModel.fromJson(Map<String, dynamic> json) => _$ApiErrorModelFromJson(json);

@override@SafeNullableIntConverter() final  int? statusCode;
@override@SafeNullableStringConverter() final  String? message;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ApiErrorModel&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._errors, _errors));
}
...
/// Create a copy of ApiErrorModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? statusCode = freezed,Object? message = freezed,Object? errors = freezed,}) {
