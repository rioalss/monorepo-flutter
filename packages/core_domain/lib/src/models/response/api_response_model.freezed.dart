...
@SafeBoolConverter() bool get success;@SafeNullableStringConverter() String? get message; T? get data; ApiErrorModel? get error; PaginatedMetaModel? get meta;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,success,message,const DeepCollectionEquality().hash(data),error,meta);
...
@useResult
$Res call({
@SafeBoolConverter() bool success,@SafeNullableStringConverter() String? message, T? data, ApiErrorModel? error, PaginatedMetaModel? meta
});


$ApiErrorModelCopyWith<$Res>? get error;$PaginatedMetaModelCopyWith<$Res>? get meta;
...
as ApiErrorModel?,meta: freezed == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@SafeBoolConverter()  bool success, @SafeNullableStringConverter()  String? message,  T? data,  ApiErrorModel? error,  PaginatedMetaModel? meta)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@SafeBoolConverter()  bool success, @SafeNullableStringConverter()  String? message,  T? data,  ApiErrorModel? error,  PaginatedMetaModel? meta)  $default,) {final _that = this;
switch (_that) {
case _ApiResponseModel():
return $default(_that.success,_that.message,_that.data,_that.error,_that.meta);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@SafeBoolConverter()  bool success, @SafeNullableStringConverter()  String? message,  T? data,  ApiErrorModel? error,  PaginatedMetaModel? meta)?  $default,) {final _that = this;
switch (_that) {
case _ApiResponseModel() when $default != null:
return $default(_that.success,_that.message,_that.data,_that.error,_that.meta);case _:
  return null;
...
class _ApiResponseModel<T> implements ApiResponseModel<T> {
  const _ApiResponseModel({@SafeBoolConverter() this.success = false, @SafeNullableStringConverter() this.message, this.data, this.error, this.meta});
...
@override@JsonKey()@SafeBoolConverter() final  bool success;
@override@SafeNullableStringConverter() final  String? message;
@override final  T? data;
@override final  ApiErrorModel? error;
...
@override $ApiErrorModelCopyWith<$Res>? get error;@override $PaginatedMetaModelCopyWith<$Res>? get meta;
