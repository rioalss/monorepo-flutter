...
mixin _$PaginatedMetaModel {
  ...
  $PaginatedMetaModelCopyWith<PaginatedMetaModel> get copyWith =>
      _$PaginatedMetaModelCopyWithImpl<PaginatedMetaModel>(
          this as PaginatedMetaModel, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, page, perPage, totalItems, totalPages, hasNext, hasPrev);
...
abstract mixin class $PaginatedMetaModelCopyWith<$Res> {
  factory $PaginatedMetaModelCopyWith(
          PaginatedMetaModel value, $Res Function(PaginatedMetaModel) _then) =
      _$PaginatedMetaModelCopyWithImpl;
  @useResult
  $Res call(
      {@SafeIntConverter() int page,
      @JsonKey(name: 'per_page') @SafeIntConverter() int perPage,
      @JsonKey(name: 'total_items') @SafeIntConverter() int totalItems,
      @JsonKey(name: 'total_pages') @SafeIntConverter() int totalPages,
      @JsonKey(name: 'has_next') @SafeBoolConverter() bool hasNext,
      @JsonKey(name: 'has_prev') @SafeBoolConverter() bool hasPrev});
}
...
extension PaginatedMetaModelPatterns on PaginatedMetaModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PaginatedMetaModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _PaginatedMetaModel() when $default != null:
        return $default(_that.page, _that.perPage, _that.totalItems,
...
class _PaginatedMetaModel implements PaginatedMetaModel {
  const _PaginatedMetaModel(
      {@SafeIntConverter() this.page = 1,
      @JsonKey(name: 'per_page') @SafeIntConverter() this.perPage = 10,
      @JsonKey(name: 'total_items') @SafeIntConverter() this.totalItems = 0,
      @JsonKey(name: 'total_pages') @SafeIntConverter() this.totalPages = 0,
      @JsonKey(name: 'has_next') @SafeBoolConverter() this.hasNext = false,
      @JsonKey(name: 'has_prev') @SafeBoolConverter() this.hasPrev = false});
  factory _PaginatedMetaModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PaginatedMetaModelCopyWith<_PaginatedMetaModel> get copyWith =>
      __$PaginatedMetaModelCopyWithImpl<_PaginatedMetaModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PaginatedMetaModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PaginatedMetaModelCopyWith<$Res>
    implements $PaginatedMetaModelCopyWith<$Res> {
  factory _$PaginatedMetaModelCopyWith(
          _PaginatedMetaModel value, $Res Function(_PaginatedMetaModel) _then) =
      __$PaginatedMetaModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@SafeIntConverter() int page,
...
mixin _$PaginatedResponseModel<T> {
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(items), meta);
...
abstract mixin class $PaginatedResponseModelCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<T> items, PaginatedMetaModel meta});
...
extension PaginatedResponseModelPatterns<T> on PaginatedResponseModel<T> {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<T> items, PaginatedMetaModel meta)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
